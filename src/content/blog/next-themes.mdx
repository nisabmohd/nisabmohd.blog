...
The component which created is a client component and can ne used in our layout file to wrap our app. lets first go to <Highlight>tailwind.config.ts</Highlight> and add the class **darkMode** property in it.
...
```tsx:app/layout.tsx showLineNumbers
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${font.className} dark:bg-zinc-950 dark:text-slate-200`}>
