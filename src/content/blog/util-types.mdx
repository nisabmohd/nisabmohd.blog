...
So you can use <Highlight>ReturnType</Highlight> utility type and can easily infer the type of function. This can also be done to normal function and reduce creating new types and importing multiple places.
...
#### Example 2 : Infer the type a function parameters.
...
#### Example 3 : Type defined and want to omit few properties in a type.

If you have a type already defined and you want to make a type simlar but want to emit few properties of the type then we can use <Highlight>Omit</Highlight> utility type to do this.
...
Explore more utility types such as <Highlight>Awaited</Highlight>,<Highlight>Readonly</Highlight> and more from <NoWrap><Link href="https://www.typescriptlang.org/docs/handbook/utility-types.html">TypeScript Docs</Link></NoWrap>.
