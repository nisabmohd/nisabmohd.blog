---
title: Generate Static Params to generate static pages at runtime for dynamic routes.
author: Nisab Mohd
description: The generateStaticParams function can be used in combination with dynamic route segments to statically generate routes at build time instead of on-demand at request timeapplications.
