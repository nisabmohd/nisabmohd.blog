...
- Like Set, it supports <Highlight>add ()</Highlight>, <Highlight>has ()</Highlight> and <Highlight>delete ()</Highlight>, but not <Highlight>size</Highlight>, <Highlight>keys ()</Highlight> and no iterations.
