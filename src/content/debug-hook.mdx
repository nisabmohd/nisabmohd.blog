...
author: Nisab Mohd
description: useDebugValue hook usage and example
...
To use **_useDebugValue_**, you simply call it with the value you want to debug inside a custom hook or a component. Then, when you inspect that component in the React DevTools, you will see the custom debug information displayed for that value.
