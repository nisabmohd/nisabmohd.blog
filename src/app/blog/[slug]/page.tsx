...
export default async function page({
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="prose prose-base  font-mono  leading-7 dark:prose-invert prose-slate prose-code:text-[13.5px] dark:prose-code:text-zinc-200 prose-code:text-zinc-800 dark:prose-code:bg-zinc-900 dark:prose-pre:bg-zinc-900 prose-code:bg-zinc-50 prose-pre:bg-zinc-50 max-[500px]:max-w-[100%] sm:max-w-[88%] prose-headings:font-normal prose-pre:font-mono">
