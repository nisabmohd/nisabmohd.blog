...
export default async function page({
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="prose prose-md font-mono dark:prose-invert prose-slate prose-code:text-[14px] prose-code:bg-zinc-900 max-[500px]:max-w-xs max-w-sm sm:max-w-prose">
