      ...
      <div className="flex sm:flex-row flex-col items-start gap-8 mt-9">
        ...
        <div className="flex-[3]">
          <p className="text-inherit prose dark:prose-invert prose-p:m-0">
            ...
            development and a deep understanding of data structures. My journey
            in the world of technology has been marked by a relentless pursuit
            of knowledge and a commitment to delivering innovative solutions.
            With expertise in a wide range of technologies, including Java,
