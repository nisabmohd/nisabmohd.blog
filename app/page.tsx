export default function Home() {
  return (
    <>
      ...
      <div className="flex flex-col gap-5 prose dark:prose-invert prose-p:m-0 text-inherit">
        <p>
          I&apos;m a passionate{" "}
          <span className="underline underline-offset-2 font-bold">
            software engineer
          </span>{" "}
          skilled in Java, JavaScript, React, Next.js, and Node.js. My love for
          data structures matches my caffeine addiction. I thrive on daily
