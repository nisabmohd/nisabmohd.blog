...
export default async function SpecificBlogPage({
  ...
  return (
    <div>
      ...
      <div className="prose dark:prose-invert prose-neutral py-8 dark:prose-code:text-zinc-200 prose-code:text-[#354150] dark:prose-code:bg-zinc-900/30 dark:prose-pre:bg-zinc-900/30 prose-code:bg-stone-50 prose-pre:bg-stone-50 prose-pre:font-code prose-headings:font-medium underline-offset-2">
        {content}
      </div>
    </div>
  );
